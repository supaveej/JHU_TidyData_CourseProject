...
createCodebook <- function(table, reporttitle, filename){
  ...
  makeCodebook(table, replace=TRUE, reportTitle = reporttitle, file=filename)
}

createCodebook(avgAccelerometerData, "Codebook for avgAccelerometerData", "codebook_avgAccelerometerData.Rmd")
createCodebook(accelerometerData, "Codebook for accelerometerData", "codebook_accelerometerData.Rmd")
